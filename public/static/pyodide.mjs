          ...
          (function (stdin) {
            ...
            function stdinWrapper() {
              try {
                ...
                throw (
                  (console.error("Error thrown in stdin:"), console.error(e), e)
                );
              }
            }
            return stdinWrapper;
...
class PyProxyClass {
  ...
  toJs({
    ...
    return 0 === idresult && Module._pythonexc2js(), Hiwire.pop_value(idresult);
  }
  supportsLength() {
    return !!(1 & this.$$flags);
  }
...
function installPackage(name, buffer) {
  return __awaiter(this, void 0, void 0, function* () {
    ...
    for (const dynlib of dynlibs) yield loadDynlib(dynlib, pkg.shared_library);
  ...
  return __awaiter(this, void 0, void 0, function* () {
    ...
    try {
      ...
      (Module.preloadedWasm[lib] = module),
        ...
        shared && Module.loadDynamicLibrary(lib, { global: !0, nodelete: !0 });
    } catch (e) {
...
function convertCppException(ptr) {
  const [exc_type_name, is_exception_subclass, adjusted_ptr] = (function (ptr) {
...
function loadPackagesFromImports(code, messageCallback, errorCallback) {
  return __awaiter(this, void 0, void 0, function* () {
    ...
    packages.size &&
      (yield loadPackage(Array.from(packages), messageCallback, errorCallback));
  });
}
...
function toPy(
  ...
  try {
    ...
    try {
      ...
      throw (
        (e instanceof Module._PropagatePythonError && Module._pythonexc2js(), e)
      );
    }
...
function loadPyodide(options = {}) {
  return __awaiter(this, void 0, void 0, function* () {
    if (loadPyodide.inProgress) throw new Error("Pyodide is already loading.");
    options.indexURL ||
